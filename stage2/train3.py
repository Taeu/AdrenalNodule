...
from dataloader import data_loader3
...
def make_parser():
    ...
    args.add_argument("--save_dir", type=str, default='./ag/result/stage2_220626/')
    args.add_argument("--exp_name", type=str, default='unet_3')
    args.add_argument("--train_batch_size", type=int, default=32)
    args.add_argument("--eval_batch_size", type=int, default=64)
    args.add_argument("--cuda", type=bool, default=True)

    # dataset
    args.add_argument("--root", type=str, default='./ag/data/stage2_220622/')
    args.add_argument("--image_dir", type=str, default='input_train')
    args.add_argument("--label_dir", type=str, default='label_train')
    args.add_argument("--output_dir", type=str, default='output_train')
    ...
    args.add_argument("--step", type=float, default=20)
    args.add_argument("--num_epochs", type=int, default=80)
...
# mulan det4
# python train.py --image_dir stage1_input_train_det4_crop --label_dir stage1_label_train_det4_crop  --output_dir stage1_output_train_det4_crop --exp_name det4_dice_3 --model_name unet --gpu_id 1
# python train.py --image_dir stage1_input_train_det4_crop --label_dir stage1_label_train_det4_crop  --output_dir stage1_output_train_det4_crop --exp_name det4_dice_with_input_3 --model_name unet --gpu_id 2
# python train.py --image_dir stage1_input_train_det4_crop --label_dir stage1_label_train_det4_crop  --output_dir stage1_output_train_det4_crop --exp_name det4_dice_with_all_input_3 --model_name unet --gpu_id 3

# mulan det2
# python train.py --image_dir stage1_input_train_det2_crop --label_dir stage1_label_train_det2_crop  --output_dir stage1_output_train_det2_crop --exp_name det2_dice_3 --model_name unet --gpu_id 0
# python train.py --image_dir stage1_input_train_det2_crop --label_dir stage1_label_train_det2_crop  --output_dir stage1_output_train_det2_crop --exp_name det2_dice_with_input_3 --model_name unet --gpu_id 1
# python train.py --image_dir stage1_input_train_det2_crop --label_dir stage1_label_train_det2_crop  --output_dir stage1_output_train_det2_crop --exp_name det2_dice_with_all_input_3 --model_name unet --gpu_id 2

# python train.py --image_dir stage1_input_train_det2_crop --label_dir stage1_label_train_det2_crop  --output_dir stage1_output_train_det2_crop --exp_name det2_dice_with_input_160 --model_name unet --gpu_id 1
...
# python train.py --image_dir stage1_input_det2_set1_epoch_82_train --label_dir stage1_label_det2_set1_epoch_82_train --output_dir stage1_output_det2_set1_epoch_82_train --exp_name 220506_det2_set1_dc_and_fc_with_input_160_unet_squeeze --model_name unet --squeeze --gpu_id 1
# python train.py --image_dir stage1_input_det2_set1_epoch_82_train --label_dir stage1_label_det2_set1_epoch_82_train --output_dir stage1_output_det2_set1_epoch_82_train --exp_name 220506_det2_set1_dc_and_fc_with_input_160_psp_squeeze --model_name pspnet --squeeze --gpu_id 0
# python train.py --image_dir stage1_input_det2_set1_epoch_82_train --label_dir stage1_label_det2_set1_epoch_82_train --output_dir stage1_output_det2_set1_epoch_82_train --exp_name 220506_det2_set1_dc_and_fc_with_input_160_hrnet_ocr --model_name hrnet --gpu_id 3

# python train3.py --exp_name det2_unet3 --model_name unet --gpu_id 0
# python train3.py --exp_name det2_unet3_dc_and_fc --model_name unet --gpu_id 1
...
def main(args):
    ...
    test_dataloader = data_loader3(args=args, phase='test', batch_size=args.eval_batch_size)
    ...
    if 'unet' in args.model_name:
        ...
        # zero_input = torch.zeros((32,3,160,160))
        # import pdb;pdb.set_trace()
    ...
    if 'focal' in args.exp_name:
        ...
        criterion = DC_and_Focal_loss({'batch_dice': True, 'smooth': 1e-5, 'do_bg': False},
    ...
    for epoch in range(args.num_epochs):
        ...
        for iter_, train_data in enumerate(train_dataloader):
            ...
            pred = model(image)
            if 'hrnet' in args.model_name:
                loss = criterion(up4(pred[0]), label)
                loss += criterion(up4(pred[1]), label)
            else:
                loss = criterion(pred, label)
            ...
            epoch_loss.append(float(loss))
            if iter_ % 50 == 0:
                print('Epoch: {} | Iteration: {} | Running loss: {:1.5f}'.format(epoch, iter_,
