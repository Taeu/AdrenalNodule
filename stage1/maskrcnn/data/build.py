...
def build_dataset(dataset_list, transforms, dataset_catalog, is_train=True):
    ...
    for dataset_name in dataset_list:
        ...
        """ example
        {'args': {'ann_file': '/data/DeepLesion/DL_info.csv',
            'data_dir': '/data/DeepLesion/Images_png',
            'split': 'train'},
        ...
        ## added by Taeu
        #args['ann_file'] = args['ann_file'][1:]
        #args['data_dir'] = args['data_dir'][1:]
        ###
        """
        {'ann_file': 'data/DeepLesion/DL_info.csv',
            'data_dir': 'data/DeepLesion/Images_png',
            'split': 'train',
            'transforms': None}
        """
...
def make_data_sampler(dataset, shuffle, distributed):
    ...
    ## added by Taeu
    #shuffle = False # to check DeepLesion Dataset for training
    ##
...
def make_data_loader(datasets, is_train=True, is_distributed=False):
    ...
    for dataset in datasets:
        ...
        num_workers = 4 #cfg.DATALOADER.NUM_WORKERS
